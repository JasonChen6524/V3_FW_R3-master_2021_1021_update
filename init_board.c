...
//#warning "WARNING: Custom boards contain no init code in initBoard. Please make sure you have created the init code needed for your board."                 // Commented by Jason Chen, 2022.06.22
void initBoard(void)
{
